...
public struct OfficeArtBlipPNG {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// rh.recInstance A value of 0x6E0 to specify one UID, or a value of 0x6E1 to specify two UIDs.
        ...
        /// recInstance equals 0x6E0, or the size of BLIPFileData plus 33 if recInstance equals 0x6E1.
        let rh = try OfficeArtRecordHeader(dataStream: &dataStream)
        guard rh.recVer == 0x0 else {
            throw OfficeFileError.corrupted
        }
        guard rh.recInstance == 0x6E0 || rh.recInstance == 0x6E1 else {
            throw OfficeFileError.corrupted
        }
        guard rh.recType == 0xF01E else {
            throw OfficeFileError.corrupted
        }
        ...
        /// This field only exists if recInstance equals 0x6E1. If this value exists, rgbUid1 MUST be ignored.
        if self.rh.recInstance == 0x6E1 {
