...
public struct PlcfTxbxHdrBkd: PLC {
    ...
    public init(dataStream: inout DataStream, size: UInt32) throws {
        ...
        /// aCP (variable): An array of CPs. CPs are positions in the header textboxes document. Each CP specifies the beginning of a range of
        /// text to appear in a textbox specified in the corresponding Tbkd structure. The range of text ends immediately prior to the next CP. The
