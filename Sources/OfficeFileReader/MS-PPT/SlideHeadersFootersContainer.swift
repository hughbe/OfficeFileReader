//
//  SlideHeadersFootersContainer.swift
//
//
...
public struct SlideHeadersFootersContainer {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// hfAtom (12 bytes): A HeadersFootersAtom record that specifies the options for displaying the footers. The hfAtom.fHasHeader sub-field
        /// MUST be ignored.
