//
//  RoundTripOArtTextStyles12Atom.swift
//
//
...
/// Referenced by: MainMasterContainer, RoundTripMainMasterRecord
/// An atom record that specifies text styles used by a main master slide.
public struct RoundTripOArtTextStyles12Atom {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// rh.recType MUST be an RT_RoundTripOArtTextStyles12Atom.
        ...
        guard self.rh.recType == .roundTripOArtTextStyles12Atom else {
            throw OfficeFileError.corrupted
        }
