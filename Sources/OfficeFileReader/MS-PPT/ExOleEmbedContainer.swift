...
public struct ExOleEmbedContainer {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// rh.recType MUST be an RT_ExternalOleEmbed.
        ...
        guard self.rh.recType == .externalOleEmbed else {
            throw OfficeFileError.corrupted
        }
        ...
        self.exOleEmbedAtom = try ExOleEmbedAtom(dataStream: &dataStream)
