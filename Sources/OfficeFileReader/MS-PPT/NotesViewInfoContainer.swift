...
/// [MS-PPT] 2.4.21.12 NotesViewInfoContainer
...
/// notes slides.
public struct NotesViewInfoContainer {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// rgGuideAtom (variable): An array of GuideAtom records that specifies guides for the notes view. It MUST NOT contain more than eight
