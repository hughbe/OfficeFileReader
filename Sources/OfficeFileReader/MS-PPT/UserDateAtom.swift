...
/// [MS-PPT] 2.4.15.3 UserDateAtom
/// Referenced by: NotesHeadersFootersContainer, PerSlideHeadersFootersContainer, SlideHeadersFootersContainer
/// An atom record that specifies the custom date for use in headers and footers.
public struct UserDateAtom {
    public let rh: RecordHeader
    public let userDate: PrintableUnicodeString
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// userDate (variable): A PrintableUnicodeString (section 2.2.23) that specifies the custom date. The length, in bytes, of the field is specified
        /// by rh.recLen.
        self.userDate = try PrintableUnicodeString(dataStream: &dataStream, byteCount: Int(self.rh.recLen))
