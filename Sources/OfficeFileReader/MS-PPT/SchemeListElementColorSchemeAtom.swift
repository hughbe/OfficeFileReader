//
//  SchemeListElementColorSchemeAtom.swift
//
//
...
/// [MS-PPT] 2.5.15 SchemeListElementColorSchemeAtom
/// Referenced by: MainMasterContainer
/// A container record that specifies a color scheme in a list of available color schemes.
public struct SchemeListElementColorSchemeAtom {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        guard self.rh.recInstance == 0x006 else {
            throw OfficeFileError.corrupted
        }
