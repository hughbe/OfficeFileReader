...
/// [MS-PPT] 2.4.22.8 BookmarkValueAtom
/// Referenced by: BookmarkEntityAtomContainer
/// An atom record that specifies the value of a bookmark.
public struct BookmarkValueAtom {
    public let rh: RecordHeader
    public let bookmarkValue: PrintableUnicodeString
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// bookmarkValue (variable): A PrintableUnicodeString (section 2.2.23) that specifies the value of this bookmark. The length, in bytes, of the
        /// field is specified by rh.recLen.
        self.bookmarkValue = try PrintableUnicodeString(dataStream: &dataStream, byteCount: Int(self.rh.recLen))
