//
//  PP10ShapeBinaryTagExtension.swift
//
//
...
/// [MS-PPT] 2.7.19 PP10ShapeBinaryTagExtension
...
public struct PP10ShapeBinaryTagExtension {
    public let rh: RecordHeader
    public let tagName: PrintableUnicodeString
    public let rhData: RecordHeader
    public let styleTextPropAtom: StyleTextProp10Atom
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// styleTextPropAtom (variable): A StyleTextProp10Atom record that specifies additional text style properties.
        self.styleTextPropAtom = try StyleTextProp10Atom(dataStream: &dataStream)
